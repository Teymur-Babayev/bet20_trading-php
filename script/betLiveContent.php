...
if ($resultBettingTitle) {
 ...
 <button class="btn btn-primary  btn-sm scoreM" href="" id="<?php echo $bettingTitle['id'] ?>" data-toggle="modal" data-target="#scoreModal">Score(<?php echo $bettingTitle['liveScore'] ?>) </button>
                                    ...
                                    ?>
                                    <img src="../img/c_ball.png" width="25px;">&nbsp; <?php echo $bettingTitle['A_team'] ?> <> <?php echo $bettingTitle['B_team'] ?> ,<?php echo $bettingTitle['title'] ?> || <?php echo substr_replace($bettingTitle['date'], "@", 12, 0) ?> 
                                    ...
                                    ?>
                                    <img src="../img/basket.png" width="30px;">&nbsp; <?php echo $bettingTitle['A_team'] ?> <> <?php echo $bettingTitle['B_team'] ?> ,<?php echo $bettingTitle['title'] ?> || <?php echo substr_replace($bettingTitle['date'], "@", 12, 0) ?> 
