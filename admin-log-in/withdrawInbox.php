                                ...
                                if ($result) {
                                    ...
                                    foreach ($result as $deposit) {
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="../index.php?adminVisit=<?php echo $deposit['userId']; ?>" target="_blank" class="btn btn-primary">visit</a> </td>
                ...
                <div class="tile-body">
                    <div class="table-responsive">
                        <table class="table table-hover table-bordered" id="sampleTable2">
                            ...
                            <tbody>
                                <?php
                                $query = "SELECT * FROM `admin_notification` WHERE seen='1' and wAction<3 and notificationType=2 and userType=0 order by id desc limit 150";
                                $result = $db->select($query);
