                                            ...
                                            <div class="col-md-8">
                                                ...
                                                <div class="">
                                                    <label>
                                                        ...
                                                        <input type="radio" name="gameType" id="gameType" value="1"><span class="label-text"> Basket</span><br>
                                                        <input type="radio" name="gameType" id="gameType" value="1"><span class="label-text"> Tennis</span><br>
