                                        ...
                                        <td>
                                            ...
                                            <div class="btn-group" role="group">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    ...
                                                    <a class="dropdown-item" href="depositWithdrawAction.php?userId=<?php echo $deposit['userId']; ?>&& amount=<?php echo $deposit['deposit']; ?> && action=2&& ref_number=<?php echo $deposit['ref_number']; ?>&& rate=<?php echo $deposit['rate']; ?> && seen=1" >Processed</a>
