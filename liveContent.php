    ...
    while ($bettingTitle = $resultBettingTitle->fetch_assoc()) {
        ...
        if ($bettingTitle['hide']) {
            ...
            <div class="panel panel-default panel2">
                <div class="panel-heading first-lebal upcome_bg" role="tab" id="headingOne<?php echo $bettingTitle['id'] ?>">
                    <h4 style="cursor: pointer" class="panel-title"  role="button" data-toggle="collapse"  href="#collapseOne<?php echo $bettingTitle['id'] ?>" aria-expanded="true" aria-controls="collapseOne<?php echo $bettingTitle['id'] ?>">
                        ...
                        if ($bettingTitle['gameType'] == 1) {
                            ?>
                            <img src="./img/1393757333.png" width="27px;">&nbsp; <?php echo $bettingTitle['A_team'] ?> <span style="color: #EFA71D">VS</span> <?php echo $bettingTitle['B_team'] ?> <br><?php echo $bettingTitle['title'] ?> || <?php echo substr_replace($bettingTitle['date'], "@", 12, 0) ?>  
                            <?php
                        } else  if ($bettingTitle['gameType']==2) {
                            ?>
                            <img src="./img/ka-pl.png" width="30px;">&nbsp; <?php echo $bettingTitle['A_team'] ?> <span style="color: #EFA71D">VS</span> <?php echo $bettingTitle['B_team'] ?> <br><?php echo $bettingTitle['title'] ?> || <?php echo substr_replace($bettingTitle['date'], "@", 12, 0) ?> 

                            <?php
                        }  else {
                              ?>
                        
                            <img src="./img/basket.png" width="30px;">&nbsp; <?php echo $bettingTitle['A_team'] ?> <span style="color: #EFA71D">VS</span> <?php echo $bettingTitle['B_team'] ?> <br><?php echo $bettingTitle['title'] ?> || <?php echo substr_replace($bettingTitle['date'], "@", 12, 0) ?> 
                            ...
                            while ($bettingSubTitle = $resultBettingSubTitle->fetch_assoc()) {
                                ...
                                if ($bettingSubTitle['hide']) {
                                    ...
                                    <div class="panel panel-default panel2">
                                        ...
                                        <div id="collapseOne<?php echo $bettingTitle['id'] ?>-two<?php echo $bettingSubTitle['id'] ?>" class="panel-collapse collapse " role="tabpanel" aria-labelledby="headingOne<?php echo $bettingTitle['id'] ?>-two<?php echo $bettingSubTitle['id'] ?>">
                                            <div class="panel-body"  style="padding: 0px 0px; background-color: #141c33;">
                                                ...
                                                if ($resultBettingSubTitleOption) {
                                                    while ($BettingSubTitleOption = $resultBettingSubTitleOption->fetch_assoc()) {
                                                        ...
                                                        if ($BettingSubTitleOption['hide']) {
                                                            ...
                                                            <div class="live-result btn btn-default btn-sm data-show buttonrate" style="cursor: pointer"
                                                                 ...
                                                                 ><?php echo $BettingSubTitleOption['title'] ?>  <span  style="color:red; "><?php echo $BettingSubTitleOption['amount'] ?></span>
