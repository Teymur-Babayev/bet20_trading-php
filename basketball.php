...
?> 
        <?php
        $query = "SELECT * FROM `betting_title` where status=1 and gameType=3 and close=0 ORDER BY date asc";
                                            ...
                                            if ($bettingSubTitle['hide']) {
                                                ...
                                                <div class="panel panel-default panel2">
                                                    ...
                                                    if ($bettingTitle['showStatus'] == 0 || $bettingSubTitle['showStatus'] == 0) {
                                                        ...
                                                        <div id="<?php echo $bettingTitle['id'] ?>-two<?php echo $bettingSubTitle['id'] ?>" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne<?php echo $bettingTitle['id'] ?>-two<?php echo $bettingSubTitle['id'] ?>">
